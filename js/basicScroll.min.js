        ...
        1: [function (t, n, e) {
            ...
            (function (t) {
                ...
                var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                    ...
                    }, o = 200, u = "__lodash_hash_undefined__", i = 9007199254740991, c = "[object Arguments]",
                    a = "[object Boolean]", s = "[object Date]", f = "[object Function]",
                    l = "[object GeneratorFunction]", p = "[object Map]", d = "[object Number]", h = "[object Object]",
                    v = "[object Promise]", b = "[object RegExp]", y = "[object Set]", _ = "[object String]",
                    m = "[object Symbol]", w = "[object WeakMap]", g = "[object ArrayBuffer]", x = "[object DataView]",
                    j = "[object Float32Array]", O = "[object Float64Array]", M = "[object Int8Array]",
                    q = "[object Int16Array]", I = "[object Int32Array]", E = "[object Uint8Array]",
                    A = "[object Uint8ClampedArray]", k = "[object Uint16Array]", P = "[object Uint32Array]",
                    S = /\w*$/, $ = /^\[object .+?Constructor\]$/, F = /^(?:0|[1-9]\d*)$/, D = {};
                D[c] = D["[object Array]"] = D[g] = D[x] = D[a] = D[s] = D[j] = D[O] = D[M] = D[q] = D[I] = D[p] = D[d] = D[h] = D[b] = D[y] = D[_] = D[m] = D[E] = D[A] = D[k] = D[P] = !0, D["[object Error]"] = D[f] = D[w] = !1;
                ...
                var K, Q = Array.prototype, X = Function.prototype, Y = Object.prototype, Z = T["__core-js_shared__"],
                    tt = (K = /[^.]+$/.exec(Z && Z.keys && Z.keys.IE_PROTO || "")) ? "Symbol(src)_1." + K : "",
                    nt = X.toString, et = Y.hasOwnProperty, rt = Y.toString,
                    ot = RegExp("^" + nt.call(et).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                    ut = C ? T.Buffer : void 0, it = T.Symbol, ct = T.Uint8Array, at = G(Object.getPrototypeOf, Object),
                    st = Object.create, ft = Y.propertyIsEnumerable, lt = Q.splice, pt = Object.getOwnPropertySymbols,
                    dt = ut ? ut.isBuffer : void 0, ht = G(Object.keys, Object), vt = Nt(T, "DataView"),
                    bt = Nt(T, "Map"), yt = Nt(T, "Promise"), _t = Nt(T, "Set"), mt = Nt(T, "WeakMap"),
                    wt = Nt(Object, "create"), gt = Vt(vt), xt = Vt(bt), jt = Vt(yt), Ot = Vt(_t), Mt = Vt(mt),
                    qt = it ? it.prototype : void 0, It = qt ? qt.valueOf : void 0;
                ...
                function St(t, n) {
                    var e, o, u,
                        i = Gt(t) || (u = o = e = t) && "object" == (void 0 === u ? "undefined" : r(u)) && Jt(o) && et.call(e, "callee") && (!ft.call(e, "callee") || rt.call(e) == c) ? function (t, n) {
                            ...
                            return r
                        }(t.length, String) : [], a = i.length, s = !!a;
                    for (var f in t) !n && !et.call(t, f) || s && ("length" == f || Rt(f, a)) || i.push(f);
                    return i
                }

                function $t(t, n, e) {
                    var r = t[n];
                    et.call(t, n) && Wt(r, e) && (void 0 !== e || n in t) || (t[n] = e)
                }

                function Ft(t, n) {
                    for (var e = t.length; e--;) if (Wt(t[e][0], n)) return e;
                    return -1
                }
                ...
                function Dt(t, n, e, r, o, u, i) {
                    ...
                    if (B) {
                        ...
                        if (N == h || N == c || C && !u) {
                            if (V(t)) return u ? t : {};
                            if (v = "function" != typeof(z = C ? {} : t).constructor || Ht(z) ? {} : Xt(T = at(z)) ? st(T) : {}, !n) return w = t, U = t, $ = (F = v) && Tt(U, Yt(U), F), Tt(w, Ct(w), $)
                        } else {
                            if (!D[N]) return u ? t : {};
                            v = function (t, n, e, r) {
                                var o = t.constructor;
                                switch (n) {
                                    ...
                                    case p:
                                        return h = t, v = e, H(r ? v(W(h), !0) : W(h), L, new h.constructor);
                                    case d:
                                    case _:
                                        return new o(t);
                                    case b:
                                    ...
                                    case y:
                                        return i = t, c = e, H(r ? c(J(i), !0) : J(i), R, new i.constructor);
                                    case m:
                    ...
                    var G, K, Q, X = i.get(t);
                    if (X) return X;
                    if (i.set(t, v), !B) var Y = e ? (K = Ct, Q = Yt(G = t), Gt(G) ? Q : function (t, n) {
                    ...
                    return function (t, n) {
                        ...
                        Y && (o = t[u = o]), $t(v, u, Dt(o, n, e, r, u, t, i))
                    }), v
                }

                function Ut(t) {
                    return !(!Xt(t) || (n = t, tt && tt in n)) && (Qt(t) || V(t) ? ot : $).test(Vt(t));
                    var n
                }
                ...
                function Tt(t, n, e, r) {
                    ...
                    for (var o = -1, u = n.length; ++o < u;) {
                        var i = n[o], c = r ? r(e[i], t[i], i, e, t) : void 0;
                ...
                function Nt(t, n) {
                    var e, r, o = (r = n, null == (e = t) ? void 0 : e[r]);
                ...
                Et.prototype.clear = function () {
                    ...
                    var e = this.__data__, r = Ft(e, t);
                    return r < 0 ? e.push([t, n]) : e[r][1] = n, this
                }, kt.prototype.clear = function () {
                    this.__data__ = {hash: new Et, map: new (bt || At), string: new Et}
                ...
                function Ht(t) {
                    ...
                    return t === ("function" == typeof n && n.prototype || Y)
                }
                ...
                (vt && Lt(new vt(new ArrayBuffer(1))) != x || bt && Lt(new bt) != p || yt && Lt(yt.resolve()) != v || _t && Lt(new _t) != y || mt && Lt(new mt) != w) && (Lt = function (t) {
                    var n = rt.call(t), e = n == h ? t.constructor : void 0, r = e ? Vt(e) : void 0;
                    if (r) switch (r) {
                        case gt:
                            return x;
                        case xt:
                ...
                function Jt(t) {
                    return null != t && ("number" == typeof(n = t.length) && n > -1 && n % 1 == 0 && n <= i) && !Qt(t);
                    var n
                }
                ...
                function Yt(t) {
                    return Jt(t) ? St(t) : function (t) {
                        if (!Ht(t)) return ht(t);
                        var n = [];
                        for (var e in Object(t)) et.call(t, e) && "constructor" != e && n.push(e);
                        return n
                    }(t)
                }
            ...
            var r = i(t("parse-unit")), o = i(t("lodash.clonedeep")), u = i(t("eases"));

            function i(t) {
                return t && t.__esModule ? t : {default: t}
            }

            var c, a, s, f = [], l = function () {
                ...
                var e = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : l(),
                    r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : window.innerHeight || window.outerHeight,
                    o = n.getBoundingClientRect(), u = t.match(/^[a-z]+/)[0], i = t.match(/[a-z]+$/)[0], c = 0;
                ...
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l(), e = t.getData(),
                    r = e.to.value - e.from.value, o = (n - e.from.value) / (r / 100),
                    u = Math.min(Math.max(o, 0), 100), i = !0 === e.direct ? e.elem : document.documentElement,
                    c = Object.keys(e.props).reduce(function (t, n) {
                        var r = e.props[n], o = r.from.unit || r.to.unit, i = r.from.value - r.to.value,
                            c = r.timing(u / 100), a = r.from.value - i * c, s = Math.round(100 * a) / 100;
                        return t[n] = s + o, t
                    }, {}), a = o < 0 || o > 100;
                ...
                Object.keys(n).forEach(function (e) {
                    return r = t, o = {key: e, value: n[e]}, void r.style.setProperty(o.key, o.value);
                    var r, o
                })
            };
            e.create = function (t) {
                var n = null, e = !1, r = {
                    isActive: function () {
                        ...
                        n = function () {
                            ...
                            if (null == (t = (0, o.default)(t)).from) throw new Error("Missing property `from`");
                            if (null == t.to) throw new Error("Missing property `to`");
                            if (null == t.inside && (t.inside = function () {
                            }), null == t.outside && (t.outside = function () {
                            }), !0 === t.direct && null == t.elem) throw new Error("Property `elem` required when `direct` is true");
                            ...
                            if (null == t.elem) {
                                if (!1 === p(t.from)) throw new Error("Property `from` must be a absolute value when no `elem` has been provided");
                                if (!1 === p(t.to)) throw new Error("Property `to` must be a absolute value when no `elem` has been provided")
                            } else !0 === h(t.from) && (t.from = v(t.from, t.elem)), !0 === h(t.to) && (t.to = v(t.to, t.elem));
                            return t.from = d(t.from), t.to = d(t.to), null == t.props && (t.props = {}), Object.keys(t.props).forEach(function (n) {
                                var e = t.props[n];
                                if (!1 === p(e.from)) throw new Error("Property `from` of prop must be a absolute value");
                                if (!1 === p(e.to)) throw new Error("Property `from` of prop must be a absolute value");
                                if (e.from = d(e.from), e.to = d(e.to), "string" == typeof e.timing && null == u.default[e.timing]) throw new Error("Unknown timing for property `timing` of prop");
                                null == e.timing && (e.timing = u.default.linear), "string" == typeof e.timing && (e.timing = u.default[e.timing])
                            }), t
                        }(t)
                    }, update: function () {
                        var t = b(r), n = t.elem, e = t.props;
                        return y(n, e), e
                    }, start: function () {
                        e = !0
                    }, stop: function () {
